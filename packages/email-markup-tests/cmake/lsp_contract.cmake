...
append_message("{\"jsonrpc\":\"2.0\",\"id\":9,\"method\":\"email-markup/preview\",\"params\":{\"uri\":\"${URI}\"}}")
...
if(NOT RESULT EQUAL 0)
  message(FATAL_ERROR "email-markup-lsp failed (${RESULT}): ${ERROR_OUTPUT}")
endif()
foreach(REQUIRED
  ...
  if(NOT OUTPUT MATCHES "${REQUIRED}")
    message(FATAL_ERROR "email-markup-lsp output omitted ${REQUIRED}: ${OUTPUT}")
  endif()
endforeach()
...
foreach(REFERENCE_ID 21 22)
  if(OUTPUT MATCHES "\\\"id\\\":${REFERENCE_ID},\\\"jsonrpc\\\":\\\"2.0\\\",\\\"result\\\":\\[\\]")
    message(FATAL_ERROR "email-markup-lsp returned no references for request ${REFERENCE_ID}: ${OUTPUT}")
  endif()
endforeach()
